...
all_simulation_results = pd.read_csv('16uniform/16uniform(delta0.001)3.csv')
...
plt.title('16 Agents Uniform Delta 0.001 Run 3')
plt.legend(loc='center right', bbox_to_anchor=(0.95, 0.65))
